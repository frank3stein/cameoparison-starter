...
<style>
  ...
  @media (min-width: 640px) {
    .card-outer {
      height: 0;
      /* padding aspect ratio trick, it is a square sitting in the middle of the container rather than trying to fill it */
      padding: 0 0 100% 0;
    }
  }
</style>
...
<div class="card-outer">
  <button
    ...
    <div class="details">
      <h2>
        <a href="https://cameo.com/${celeb.id}">{celeb.name}</a>
      </h2>
